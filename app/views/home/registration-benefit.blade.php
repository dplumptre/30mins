...
<div class="col-lg-12 ">
    ...
    <p class="text-justify">As a registered member you get to enjoy the following benefits</p>    
    <ul>

         <li>You receive regular prayer promises</li>
         <li>You will be able to post your testimonies</li>
         <li>You get to edit your testimonies in case of errors</li>
    </ul>  
</div>
