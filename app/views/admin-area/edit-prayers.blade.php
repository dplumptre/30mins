...
{{ Form::model($specshout, array('route' => array('admin-area.update-prayers', $specshout->id), 'method' => 'PUT')) }}


        
        {{ Form::label( 'Testimony','Enter Prayer')}}
        {{ Form::textarea( 'message',null, array('class' => 'form-control','placeholer' => 'Enter Prayer','maxlength'=>'200') ) }}

         <br />
        {{ Form::submit( 'Edit Prayer',array('class' =>'btn  btn-warning'))}}  
