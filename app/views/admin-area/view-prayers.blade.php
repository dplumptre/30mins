...
{{ Form::open(array('url' => 'admin-area/view-prayers/' . $news->id, 'class' => 'pull-right ')) }}
...
<!--
           ...
           -->
           {{ HTML::link('admin-area/view-prayers/'.$news->id.'/edit-prayers','',array('class'=>'btn btn-warning fa fa-edit'))}}
