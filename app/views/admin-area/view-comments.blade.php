<?php  $users = Auth::user();
$row = Comment::with('users')->orderBy('id', 'DESC')->get();
$mycode = new MyCode();
?>
...
{{ Form::open(array('url' => 'admin-area/view-comments/' . $news->id, 'class' => 'pull-right ')) }}
...
<!--
           ...
           -->
           {{ HTML::link('admin-area/view-comments/'.$news->id.'/edit-comments','',array('class'=>'btn btn-warning fa fa-edit'))}}
