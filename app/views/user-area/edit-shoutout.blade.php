...
{{ Form::model($specshout, array('route' => array('user-area.update-shoutout', $specshout->id), 'method' => 'PUT')) }}


        
        {{ Form::label( 'Testimony','Enter Testimony')}}
        {{ Form::textarea( 'message',null, array('class' => 'input-sm form-control','placeholer' => 'Enter Testimony') ) }}
