...
{{ Form::open(array('url' => 'user-area/' . $news->id, 'class' => 'pull-right ')) }}
...
<!--
           ...
           -->
           {{ HTML::link('user-area/'.$news->id.'/edit-shoutout','',array('class'=>'btn btn-warning fa fa-edit'))}}
