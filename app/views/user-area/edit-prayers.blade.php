...
{{ Form::model($specshout, array('route' => array('user-area.update-prayers', $specshout->id), 'method' => 'PUT')) }}


        
        {{ Form::label( 'Testimony','Enter Prayer')}}
        {{ Form::textarea( 'message',null, array('class' => 'input-sm form-control','placeholer' => 'Enter Prayer') ) }}
